...
class Timer
{
  ...
  public:
    ...
    void stop()
    {
      ...
      _running = false;
      _usecs += (suseconds_t)(1000000) * (suseconds_t)(_tend.tv_sec - _tstart.tv_sec) + (suseconds_t)(_tend.tv_usec - _tstart.tv_usec);
        //return _usecs;
    }

    //! Time at last stop (initially zero)
    suseconds_t value() const { return _usecs; } /* in microseconds */
    suseconds_t usecs() const { return _usecs; } /* in microseconds */
    suseconds_t msecs() const { return _usecs/1000; } /* in milliseconds */
    ...
    suseconds_t usecs_since_mark() const { return _usecs - _usecs_at_mark; }
};
